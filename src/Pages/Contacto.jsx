...
const Contacto = () => {
  ...
  const destinatarios = [
    {
      id: "all",
      label: "BROADCAST_TOTAL (Todos los Arquitectos)",
      email: "proyecto.videojuegos.2526@gmail.com",
    },
    {
      id: "arch_01",
      label: "David Jiménez Villena (Web/Gamer Dev)",
      email: "davidjimenezvillena@gmail.com",
    },
    {
      id: "arch_02",
      label: "Luis Miguel Escuderos (3D Art)",
      email: "luismiguelescuderoalcaide10@gmail.com",
    },
    {
      id: "arch_03",
      label: "Víctor Hugo Jiménez (Producer)",
      email: "victorhugojimenezmeseguer@gmail.com",
    },
    {
      id: "arch_04",
      label: "José Andrés Garrido (3D/2D Art)",
      email: "joseandresgarridoguti@gmail.com",
    },
    {
      id: "arch_05",
      label: "Óscar González (Gamer Dev/Art)",
      email: "oscarge10.oge@gmail.com",
    },
    {
      id: "arch_06",
      label: "Eva Góngora (Art Director)",
      email: "evagfvdg@gmail.com",
    },
    {
      id: "arch_07",
      label: "Francisco Torres (Gamer Dev)",
      email: "franciscotorrespuche@gmail.com",
    },
    {
      id: "arch_08",
      label: "Rafael Soler (Gamer Dev/UX)",
      email: "rafasc3000@gmail.com",
    },
    {
      id: "arch_09",
      label: "Michel Mendoza (Gamer Developer)",
      email: "michel.mendoza@gmail.com",
    },
    {
      id: "arch_10",
      label: "Javier Soriano Moreno (Gamer Developer)",
      email: "soriano8822@gmail.com",
    },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 font-elite">
          ...
          >
            <div className="flex items-center gap-3 text-red-600">
              <FaBroadcastTower />
              <h2 className="text-xl tracking-widest uppercase font-bold text-zinc-200">
              ...
              {[
                {
                  ...
                  icon: <FaInstagram />,
                  user: "@Intrusion_Game",
                  link: "https://www.instagram.com/intrusion_game?igsh=MTNveTVlbDViMXltZA==",
                },
                {
                  name: "Itch.io",
                  icon: <FaItchIo />,
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-sm text-zinc-300 group-hover:text-red-500 transition-colors font-elite">
                        {social.user}
                      </span>
                    </div>
                  </div>
          ...
          >
            ...
            <form ref={form} onSubmit={sendEmail} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-[10px] uppercase tracking-widest text-zinc-600 mb-2 font-bold font-elite">
                    Identificador
                  </label>
                  <input
                    type="text"
                    name="user_name"
                    required
                    className="w-full bg-black border border-zinc-900 p-3 text-sm focus:border-red-700 outline-none text-zinc-300 font-elite"
                    placeholder="SUJETO_00"
                  />
                </div>
                <div>
                  <label className="block text-[10px] uppercase tracking-widest text-zinc-600 mb-2 font-bold font-elite">
              ...
              <div>
                <label className="flex items-center gap-2 text-[10px] uppercase tracking-widest text-zinc-600 mb-2 font-bold font-elite">
                  <FaEnvelopeOpenText className="text-zinc-700" size={10} />{" "}
                  Encabezado
                </label>
                <input
                  type="text"
                  ...
                  required
                  className="w-full bg-black border border-zinc-900 p-3 text-sm focus:border-red-700 outline-none text-zinc-300 font-elite"
                  placeholder="ERR_LOG: FALLO EN EL SISTEMA"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows="4"
                  required
                  className="w-full bg-black border border-zinc-900 p-3 text-sm focus:border-red-700 outline-none text-zinc-300 font-elite resize-none"
              ...
              <button
                type="submit"
                className="w-full bg-red-950/20 border border-red-900 hover:bg-red-900 hover:text-white transition-all py-4 text-xs tracking-[0.4em] uppercase font-bold active:scale-95 shadow-[0_0_15px_rgba(153,27,27,0.1)] font-elite"
              >
                Transmitir Datos
              </button>
